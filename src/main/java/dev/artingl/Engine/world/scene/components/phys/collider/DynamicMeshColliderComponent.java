...
public class DynamicMeshColliderComponent extends BaseColliderComponent {

    private final IMesh mesh;
    private GImpactCollisionShape shape;

    public DynamicMeshColliderComponent(IMesh mesh) {
        this.mesh = mesh;
    }
    ...
    protected CollisionShape buildCollider() {
        if (shape == null && mesh.isBaked()) {
            ...
            this.shape = new GImpactCollisionShape(mesh);
        }
