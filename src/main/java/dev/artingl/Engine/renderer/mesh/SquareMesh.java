    ...
    public SquareMesh(float width, float height, Color color, Texture texture) {
        super(
                new VerticesBuffer(VerticesBuffer.Attribute.VEC3F, VerticesBuffer.Attribute.VEC3F, VerticesBuffer.Attribute.VEC2F)
                        .addAttribute(new Vector3f(-(0.5f * width), -(0.5f * height), 0)).addAttribute(new Vector3f(0)).addAttribute(new Vector2f(0, 0))
                        .addAttribute(new Vector3f(0.5f * width, -(0.5f * height), 0)).addAttribute(new Vector3f(0)).addAttribute(new Vector2f(1, 0))
                        .addAttribute(new Vector3f(-(0.5f * width), 0.5f * height, 0)).addAttribute(new Vector3f(0)).addAttribute(new Vector2f(0, 1))

                        .addAttribute(new Vector3f(0.5f * width, 0.5f * height, 0)).addAttribute(new Vector3f(0)).addAttribute(new Vector2f(1, 1))
                        .addAttribute(new Vector3f(-(0.5f * width), 0.5f * height, 0)).addAttribute(new Vector3f(0)).addAttribute(new Vector2f(0, 1))
                        .addAttribute(new Vector3f(0.5f * width, -(0.5f * height), 0)).addAttribute(new Vector3f(0)).addAttribute(new Vector2f(1, 0))
        );
