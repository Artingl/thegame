...
public class Chunk {
    ...
    private final List<Pair<EnvironmentObjects, Vector3f>> envObjectsList;

    public Chunk(Level level, Vector2i chunkPosition) {
        this.position = chunkPosition;
        this.level = level;
        this.mesh = new ChunkMesh(this, level);
        this.envObjectsList = new ArrayList<>();
...
//        });
     ...
     * */
    public List<Pair<EnvironmentObjects, Vector3f>> getEnvObjectsList() {
